...
$data_mobil = select("SELECT * FROM pendaftaran");
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav gap-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="adminsetting.php">
    ...
    <div class="container mt-5">
        ...
        <div class="card shadow-lg">
            <div class="card-header text-white">
                <h4 class="mb-0"><i class="bi bi-table me-2"></i>Admin Setting </h4>
            </div>
            <div class="card-body">
                                ...
                                <?php foreach ($data_mobil as $data): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="ubah/ubah_setting.php?id=<?= $data['id']; ?>" class="btn btn-success btn-sm me-1" title="Ubah">
                                                <i class="bi bi-pencil-square icon-action"></i>
                                            </a>
                                            <a href="hapus/hapus_setting.php?id=<?= $data['id']; ?>" class="btn btn-danger btn-sm" title="Hapus" onclick="return confirm('Yakin ingin menghapus data mobil ini?');">
